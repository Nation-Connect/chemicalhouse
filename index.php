...
<body>
        ...
        <div id="bootcarousel" class="carousel transparent-nav text-center inc-top-heading slide carousel-fade animate_text" data-ride="carousel">
            ...
            <div class="carousel-inner text-light carousel-zoom">
                <div class="item active">
                    <div class="slider-thumb bg-cover" style="background-image: url(assets/img/banner/b.png);"></div>
                ...
                <div class="item">
                    <div class="slider-thumb bg-cover" style="background-image: url(assets/img/banner/c.jpg);"></div>
                    <div class="box-table shadow dark">
                        <div class="box-cell">
                            <div class="container">
                                <div class="row">
    ...
    <!-- Start Features
    ============================================= -->
    <div class="top-features-area about-area default-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-6 management-quote">
                    <h2>What management say</h2>
    ...
    <!-- Start Our About
    ============================================= -->
    <div class="about-area reverse bg-gray inc-video default-padding">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <form action="assets/mail/contact-2.php" method="POST" class="contact-form">
                        <div class="col-md-12">
                            <div class="row">
                ...
                <div class="col-md-7 clients-box">
                    <div class="clients-items owl-carousel owl-theme text-center">
                        <div class="single-item">
                            <a href="#"><img src="assets/img/Sd Biosensor.jpg" alt="Clients" style="height: 134px;" style="height: 134px;"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="assets/img/VeinSpy_Advt.jpg" alt="Clients" style="height: 134px;"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="assets/img/Sd Biosensor.jpg" alt="Clients" style="height: 134px;"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="assets/img/VeinSpy_Advt.jpg" alt="Clients" style="height: 134px;"></a>
                        </div>
